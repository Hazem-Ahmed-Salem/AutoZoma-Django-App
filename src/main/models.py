...
class Listing(models.Model):
    ...
    brand = models.CharField(max_length=30 ,choices= CAR_BRANDS , default=None)
...
class LikedListing(models.Model):
    ...
    def __str__(self):
        return f'{self.listing.brand} {self.listing.model} liked by {self.profile.user.username}'